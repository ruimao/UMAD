if "%dataType%"=="vector" set CurCMD=UMAD --runOption build --buildMode %BuildMode% --indexName vector_%Size%_%BuildMode%_v2_f3_m100 --n uniformvector-20dim-1m.txt --v 2 --f 3 --t vector --e MVPIndex --psm fft --dpm PivotWise --m 100 --init %Size% --F %Size% --s 2000 --dim 6 --res results_vector_build_%Size%i_%BuildMode%_fft_PivotWise_MVPIndex_v2_f3_m100_dim20.txt --tR 0.1 --sop %sop% --pbop %pbop%
...
if "%dataType%"=="image" set CurCMD=UMAD --runOption build --buildMode %BuildMode% --indexName image_%Size%_%BuildMode%_v2_f3_m100 --n allfeas.dat --v 2 --f 3 --t image --e MVPIndex --psm fft --dpm PivotWise --m 100 --init %Size% --F %Size% --s 2000 --dim 66 --res results_image_build_%Size%i_%BuildMode%_fft_PivotWise_MVPIndex_v2_f3_m100_dim66.txt --tR 0.05 --sop %sop% --pbop %pbop%
if "%dataType%"=="dna" set CurCMD=UMAD --runOption build --buildMode %BuildMode% --indexName dna_%Size%_%BuildMode%_v2_f3_m100 --n dna.con --v 2 --f 3 --t dna --e MVPIndex --psm fft --dpm PivotWise --m 100 --init %Size% --F %Size% --s 2000 --frag 18 --res results_dna_build_%Size%i_%BuildMode%_fft_PivotWise_MVPIndex_v2_f3_m100_frag18.txt --tR 1 --sop %sop% --pbop %pbop%
if "%dataType%"=="peptide" set CurCMD=UMAD --runOption build --buildMode %BuildMode% --indexName peptide_%Size%_%BuildMode%_v2_f3_m100 --n nrall.fasta --v 2 --f 3 --t peptide --e MVPIndex --psm fft --dpm PivotWise --m 100 --init %Size% --F %Size% --s 2000 --frag 6 --res results_peptide_build_%Size%i_%BuildMode%_fft_PivotWise_MVPIndex_v2_f3_m100_frag6.txt --tR 1 --sop %sop% --pbop %pbop%
